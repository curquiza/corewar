...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/10 10:50:17 by curquiza          #+#    #+#             */
/*   Updated: 2019/01/10 10:50:21 by curquiza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_op g_op[OP_NUMBER] =
{
	...
	{ 0x04, "add", 3, { T_REG, T_REG, T_REG }, 10, TRUE, FALSE, &op_add },
	{ 0x05, "sub", 3, { T_REG, T_REG, T_REG }, 10, TRUE, FALSE, &op_sub },
	...
	{ 0x0d, "lld", 2, { T_DIR | T_IND, T_REG }, 10, TRUE, FALSE, &op_lld },
	{ 0x0e, "lldi", 3, { T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG },
		50, TRUE, TRUE, &op_lldi },
